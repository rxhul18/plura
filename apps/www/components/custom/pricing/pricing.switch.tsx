...
export default function PricingSwitch({onYearlyBillingChange}: PricingSwitchProps) {
  ...
  return (
    ...
    <Switch id="yearly-mode" checked={isYearly}
          onCheckedChange={setIsYearly}
           />
    <Label htmlFor="yearly-mode" className="transition-all duration-300">Billed Yearly</Label>
  </div>
  );
}
