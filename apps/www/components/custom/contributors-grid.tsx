...
export default function ContributorsGrid({ data }: ContributorsGridProps) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-5 lg:grid-cols-6 gap-10 mt-10 mb-8 px-10 items-center justify-center">
      <TooltipProvider>
        {data.map((contributor, i) => (
          <BlurFade key={contributor.id} delay={0.25 * i}>
            <Tooltip>
              <TooltipTrigger className="flex items-center gap-2 rounded-lg shadow-sm hover:shadow-md transition-all cursor-help">
