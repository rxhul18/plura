...
export function ServiceDragableNode({ type, id, data, onDelete, onDrop }: ServiceNodeProps) {
    ...
    return (
        ...
        >
            <div className="w-full p-2 bg-white shadow-md rounded-lg relative min-w-[150px] border">
