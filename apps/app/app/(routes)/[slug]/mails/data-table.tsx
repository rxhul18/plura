...
export function DataTable<TData, TValue>({
    ...
    const handleDownload = async () => {
        ...
        const filteredData = (data as Record<string, unknown>[]).map(filterVisibleFields);
        exportFromJSON({
            data: filteredData,
                        ...
                        {table.getHeaderGroups().map((headerGroup) => (
                            <TableRow key={headerGroup.id}>
                                {headerGroup.headers.map((header) => {
                                    return (
                                        <TableHead key={header.id} className={`${(header.column.id === "Source"
                            ...
                            table.getRowModel().rows.map((row) => (
                                ...
                                >
                                    {row.getVisibleCells().map((cell) => (
                                        <TableCell key={cell.id} className={`${(cell.column.id === "Source"
